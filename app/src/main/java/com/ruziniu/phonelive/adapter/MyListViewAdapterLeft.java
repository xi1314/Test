 ...
 */
public class MyListViewAdapterLeft extends BaseAdapter{

    private final ArrayList<UserBean> mMenus;
    private final Context context;
    private int selectIndex;

    public MyListViewAdapterLeft(ArrayList<UserBean> mMenus, Context context, int selectIndex){
        this.mMenus=mMenus;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder vh;
        if(convertView==null){
            convertView=View.inflate(context, R.layout.item_listview_left,null);
            vh=new ViewHolder();
       ...
       //左上右下
        ...
        vh.tv.setText(mMenus.get(position).getTitle());
        return convertView;
    }
