...
public class DoubleClickExitDetector {
     ...
     */
    public DoubleClickExitDetector(Activity context, String hintMessage, int effectiveIntervalTime) {
     ...
     * @param hintMessage 提示消息
     */
    public DoubleClickExitDetector(Activity context, String hintContent) {
     ...
     * @param context Androdi上下文
     */
    public DoubleClickExitDetector(Activity context) {
    ...
    public boolean click(){
        ...
        if(!result){
            AppContext.showToastAppMsg(context,hintMessage);
        }
        return result;
    }
