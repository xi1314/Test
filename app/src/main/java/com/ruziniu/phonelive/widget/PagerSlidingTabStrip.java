...
import com.ruziniu.phonelive.interf.PagerSlidingInterface;
...
public class  PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabPadding = (int) getResources().getDimensionPixelSize(R.dimen.text_size_5);
    ...
    private PagerSlidingInterface mPagerSlidingInterface;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        HorizontalScrollView.LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        tabsContainer.setGravity(Gravity.CENTER);
        //tabsContainer.setBackgroundColor(getResources().getColor(R.color.red));
    ...
    public void setTextSize(int textSizeSp) {
        this.tabTextSize = textSizeSp/*(int) TypedValue.applyDimension(
