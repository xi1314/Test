package com.ruziniu.phonelive.widget.music;
...
public class LrcView extends View implements ILrcView{
	...
	private int mHignlightRow = 2;   // current singing row , should be highlighted.
	...
	private String mLoadingLrcTip = "没有搜索到该歌曲歌词";
	...
	protected void onDraw(Canvas canvas) {
		...
		// 1 highlight row
		if(!(mLrcRows.size() >= mHignlightRow)){
			return;
		}
